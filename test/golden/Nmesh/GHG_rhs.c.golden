...
double *dtPhi103 = Vard(node, Vind(vlr,GHG->i_Phixtt+3));
double *dtPhi111 = Vard(node, Vind(vlr,GHG->i_Phixtt+4));
double *dtPhi112 = Vard(node, Vind(vlr,GHG->i_Phixtt+5));
double *dtPhi113 = Vard(node, Vind(vlr,GHG->i_Phixtt+6));
double *dtPhi122 = Vard(node, Vind(vlr,GHG->i_Phixtt+7));
double *dtPhi123 = Vard(node, Vind(vlr,GHG->i_Phixtt+8));
double *dtPhi133 = Vard(node, Vind(vlr,GHG->i_Phixtt+9));
double *dtPhi200 = Vard(node, Vind(vlr,GHG->i_Phixtt+10));
double *dtPhi201 = Vard(node, Vind(vlr,GHG->i_Phixtt+11));
double *dtPhi202 = Vard(node, Vind(vlr,GHG->i_Phixtt+12));
double *dtPhi203 = Vard(node, Vind(vlr,GHG->i_Phixtt+13));
double *dtPhi211 = Vard(node, Vind(vlr,GHG->i_Phixtt+14));
double *dtPhi212 = Vard(node, Vind(vlr,GHG->i_Phixtt+15));
double *dtPhi213 = Vard(node, Vind(vlr,GHG->i_Phixtt+16));
double *dtPhi222 = Vard(node, Vind(vlr,GHG->i_Phixtt+17));
double *dtPhi223 = Vard(node, Vind(vlr,GHG->i_Phixtt+18));
double *dtPhi233 = Vard(node, Vind(vlr,GHG->i_Phixtt+19));
double *dtPhi300 = Vard(node, Vind(vlr,GHG->i_Phixtt+20));
double *dtPhi301 = Vard(node, Vind(vlr,GHG->i_Phixtt+21));
double *dtPhi302 = Vard(node, Vind(vlr,GHG->i_Phixtt+22));
double *dtPhi303 = Vard(node, Vind(vlr,GHG->i_Phixtt+23));
double *dtPhi311 = Vard(node, Vind(vlr,GHG->i_Phixtt+24));
double *dtPhi312 = Vard(node, Vind(vlr,GHG->i_Phixtt+25));
double *dtPhi313 = Vard(node, Vind(vlr,GHG->i_Phixtt+26));
double *dtPhi322 = Vard(node, Vind(vlr,GHG->i_Phixtt+27));
double *dtPhi323 = Vard(node, Vind(vlr,GHG->i_Phixtt+28));
double *dtPhi333 = Vard(node, Vind(vlr,GHG->i_Phixtt+29));
...
double *AdPhi100 = Vard(node, iAdPhixtt);
double *AdPhi101 = Vard(node, iAdPhixtt+1);
double *AdPhi102 = Vard(node, iAdPhixtt+2);
double *AdPhi103 = Vard(node, iAdPhixtt+3);
double *AdPhi111 = Vard(node, iAdPhixtt+4);
double *AdPhi112 = Vard(node, iAdPhixtt+5);
double *AdPhi113 = Vard(node, iAdPhixtt+6);
double *AdPhi122 = Vard(node, iAdPhixtt+7);
double *AdPhi123 = Vard(node, iAdPhixtt+8);
double *AdPhi133 = Vard(node, iAdPhixtt+9);
double *AdPhi200 = Vard(node, iAdPhixtt+10);
double *AdPhi201 = Vard(node, iAdPhixtt+11);
double *AdPhi202 = Vard(node, iAdPhixtt+12);
double *AdPhi203 = Vard(node, iAdPhixtt+13);
double *AdPhi211 = Vard(node, iAdPhixtt+14);
double *AdPhi212 = Vard(node, iAdPhixtt+15);
double *AdPhi213 = Vard(node, iAdPhixtt+16);
double *AdPhi222 = Vard(node, iAdPhixtt+17);
double *AdPhi223 = Vard(node, iAdPhixtt+18);
double *AdPhi233 = Vard(node, iAdPhixtt+19);
double *AdPhi300 = Vard(node, iAdPhixtt+20);
double *AdPhi301 = Vard(node, iAdPhixtt+21);
double *AdPhi302 = Vard(node, iAdPhixtt+22);
double *AdPhi303 = Vard(node, iAdPhixtt+23);
double *AdPhi311 = Vard(node, iAdPhixtt+24);
double *AdPhi312 = Vard(node, iAdPhixtt+25);
double *AdPhi313 = Vard(node, iAdPhixtt+26);
double *AdPhi322 = Vard(node, iAdPhixtt+27);
double *AdPhi323 = Vard(node, iAdPhixtt+28);
double *AdPhi333 = Vard(node, iAdPhixtt+29);
...
double invh11
=
detinvh*(-Power(g23[ijk],2) + g22[ijk]*g33[ijk])
;

double invh12
=
detinvh*(g13[ijk]*g23[ijk] - g12[ijk]*g33[ijk])
;

double invh13
=
detinvh*(-(g13[ijk]*g22[ijk]) + g12[ijk]*g23[ijk])
;

double invh22
=
detinvh*(-Power(g13[ijk],2) + g11[ijk]*g33[ijk])
;

double invh23
=
detinvh*(g12[ijk]*g13[ijk] - g11[ijk]*g23[ijk])
;

double invh33
=
detinvh*(-Power(g12[ijk],2) + g11[ijk]*g22[ijk])
;
